...
class AutoPRFClient:
    ...
    def pesquisa_auto_infracao(self, auto_infracao: str) -> dict:
        ...
        try:
            ...
            result["medicoes"]["limite"] = driver.find_element(By.NAME,"limitePermitido0").get_attribute("value") 
            excesso = int(result["medicoes"]["considerada"]) - int(result["medicoes"]["limite"])
            result["medicoes"]["excesso"] = str(excesso)

            # Equipamento 
            result["medicoes"]["numero"] = driver.find_element(By.NAME,"numeroEquipamentoMedicoes").get_attribute("value") 
        ...
        # Observações
        result["observacoes"] = driver.find_element(By.NAME,"observacaoDigitada").get_attribute("value") 
