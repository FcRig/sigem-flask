...
export function obterUnidades(payload) {
  return api.post('/api/sei/unidades',payload)
}
...
export function procurarProcesso(payload){
  return api.post('/api/sei/procurar-processo', payload);
}